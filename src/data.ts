export const TESTIMONIALS = [
  {
    quote: "I’ve partnered with Andrew on multiple website builds now, including my podcast producer site and a petsitting website. Being able to hop on a quick call and see the changes I want to make in real time has been a game-changer. Whenever I need to update something, add a new feature, or build out a new page, we can just make those changes on the fly. It completely eliminates the usual back-and-forth delay of web development.",
